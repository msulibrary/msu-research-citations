...
CREATE TABLE IF NOT EXISTS `affiliations` (
  ...
  `name_affiliation_email` varchar(255) NOT NULL COMMENT 'author affiliation email',
  ...
  FULLTEXT KEY `name_affiliation_email` (`name_affiliation_email`),
  ...
  FULLTEXT KEY `name_affiliation_otherAffiliation` (`name_affiliation_otherAffiliation`)
